...
return {
	...
	DESCRIBE =
	{
        ...
        WX78 =
        {
            ...
            ATTACKER = "You little rubbish machine!",
            MURDERER = "You seem a bit more intense than I had planned for today...",
            REVIVER = "Thanks. But you really didn't have to go and get me revived.",
            GHOST = "Ha! Brainless machine!",
            FIRESTARTER = "Fire by garbage...",
        },
        WILLOW =
        {
		...
		TRINKET_1 = "I'm sure Bonobono would love these.", --Melted Marbles
		TRINKET_2 = "Useless. It doesn't make sound.", --Fake Kazoo
		TRINKET_3 = "This knot seems too strong for me to loosen it up.", --Gord's Knot
		TRINKET_4 = "Is this a statue?", --Gnome
		TRINKET_5 = "I have no clue what this is.", --Toy Rocketship
		TRINKET_6 = "These may be useful if I were a machine.", --Frazzled Wires
		TRINKET_7 = "I should make something like this at home!", --Ball and Cup
		TRINKET_8 = "This is an unusual bucket for sure.", --Rubber Bung
		TRINKET_9 = "Are these money?", --Mismatched Buttons
		TRINKET_10 = "Who lose their teeth like that?!", --Dentures
		TRINKET_11 = "This machine ain't moving.", --Lying Robot
		TRINKET_12 = "Yuck. This one is like a dead caterpillar.", --Dessicated Tentacle
		TRINKET_13 = "It's a statue but more prettier.", --Gnomette
		TRINKET_14 = "I guess this one's a bucket too?", --Leaky Teacup
		TRINKET_15 = "...Maxwell left his stuff out again.", --Pawn
		TRINKET_16 = "I dunno what is this. Even.", --Pawn
		TRINKET_17 = "This one's trash.", --Bent Spork
		TRINKET_18 = "I don't see any exact beast like this around here.", --Trojan Horse
		TRINKET_19 = "Is this a toy?", --Unbalanced Top
		TRINKET_20 = "Aha! Now this is what I totally want!", --Backscratcher
		TRINKET_21 = "This one must have been a weapon.", --Egg Beater
		TRINKET_22 = "This string must be really old.", --Frayed Yarn
		TRINKET_23 = "Is this a paddle?", --Shoehorn
		TRINKET_24 = "This one reminds of that ol' fishing cat!", --Lucky Cat Jar
		...
		TRINKET_28 = "Looks like a sandcastle.", --Rook
        TRINKET_29 = "Looks like a sandcastle.", --Rook
        TRINKET_30 = "That one looks familiar.", --Knight
        TRINKET_31 = "That one looks familiar.", --Knight
        TRINKET_32 = "Wow. It looks clear. Almost.", --Cubic Zirconia Ball
        TRINKET_33 = "Whoever made this is good at pranking!", --Spider Ring
        TRINKET_34 = "What the heck is this?! Too freaky!", --Monkey Paw
        TRINKET_35 = "This isn't what I expected.", --Empty Elixir
        TRINKET_36 = "Oh, those are for losers who wanna be a raccoon like me.", --Faux fangs
        TRINKET_37 = "Huh, looks broken.", --Broken Stake
        TRINKET_38 = "There's nothing inside.", -- Binoculars Griftlands trinket
        ...
        WINTER_FOOD1 = "Holy moly, that smells amazing!", --gingerbread cookie
        WINTER_FOOD2 = "Those look so deliciously sweet and soft.", --sugar cookie
        WINTER_FOOD3 = "It's shaped like a hook!", --candy cane
        WINTER_FOOD4 = "Ugh, it looks like my dad's leftovers. Blech!", --fruitcake
        WINTER_FOOD5 = "Now that's some serious baking skills right there!", --yule log cake
        WINTER_FOOD6 = "Looks kinda like mud, but smells really good!", --plum pudding
        WINTER_FOOD7 = "Mmm... so refreshing!", --apple cider
        WINTER_FOOD8 = "Ooh, nice and hot!", --hot cocoa
        WINTER_FOOD9 = "It's some kinda weird animal milk.", --eggnog
		
		WINTERSFEASTOVEN =
		{
			GENERIC = "Huh... it's empty.",
			COOKING = "There's a delicious meal waiting inside.",
			ALMOST_DONE_COOKING = "Mmmm, smells like food now.",
			DISH_READY = "This baby and I are gonna get real cozy!",
		},
		...
		TABLE_WINTERS_FEAST =
		{
			GENERIC = "Let's whip out a feast on this fancy slab!",
        ...
        MASHEDPOTATOES = "Now you're speaking my language!",
        POTATOSOUFFLE = "I forgot what good food tasted like.",
        MOQUECA = "How'd that chef come up with this crazy-delicious stew?",
        GAZPACHO = "It's some kind of weird forest slime.",
        ASPARAGUSSOUP = "Nice and tender.",
        VEGSTINGER = "The filling is so gooey and delicious!",
        BANANAPOP = "Mmmm, this is the stuff dreams are made of!",
        CEVICHE = "Straight from the river to my belly!",
        SALSA = "So... hot...!",
        PEPPERPOPPER = "What a mouthful!",

        TURNIP = "It's kinda weird, but definitely different from anything I've tried before.",
        TURNIP_COOKED = "This is really good.",
        TURNIP_SEEDS = "A handful of odd seeds.",
        
        GARLIC = "How can anyone stand the smell of this stuff?",
        GARLIC_COOKED = "Hey! It's actually pretty good!",
        GARLIC_SEEDS = "A handful of odd seeds.",
        
        ONION = "What's it even good for besides making people cry?",
        ONION_COOKED = "Hmm, not bad...",
        ONION_SEEDS = "A handful of odd seeds.",
        
        POTATO = "Mmmm, nothing beats the smell of a fresh potato!",
        POTATO_COOKED = "Gimme gimme gimme!",
        POTATO_SEEDS = "A handful of odd seeds.",
        
        TOMATO = "Hmph, at least it doesn't smell terrible...",
        TOMATO_COOKED = "Hmm, maybe that changes things...",
        TOMATO_SEEDS = "A handful of odd seeds.",

        ASPARAGUS = "They're all pointy and weird-looking.", 
        ASPARAGUS_COOKED = "I suppose I could take a nibble.",
        ASPARAGUS_SEEDS = "It's asparagus seeds.",

        PEPPER = "Smells kinda funny...",
        PEPPER_COOKED = "I guess even pepper can grow on you.",
        ...
        BEARGERCORPSE =
        {
            ...
            REVIVING = "Wh-what?! Dead things can't move or breathe! Impossible!",
        },
        ...
        OTTER = "I'll show you who's boss!",
        OTTERDEN = {
            GENERIC = "Might be worth checking out, just to see how those lazy bums live.",
            HAS_LOOT = "I bet it's cluttered with fish bones and half-eaten meals.",
        },
        OTTERDEN_DEAD = "It won't dare touch my stuff again after that.",
        ...
        RABBITKING_AGGRESSIVE = "Aww, a little wimpy bunny being angry? Pathetic.",
        RABBITKING_PASSIVE = "What a bunch of garbage!",
        RABBITKING_LUCKY = "Hmm, I'll have to prepare a trap or somethin'...",
        RABBITKINGMINION_BUNNYMAN = "These bunnies are leading me to a whole run!",
        ARMOR_CARROTLURE = "Heh, A suit of carrots eh? What a waste...",
        RABBITKINGHORN = "Maybe I could even use it to intimidate Bonobono.",
        RABBITKINGHORN_CHEST = "It's like a grave for my things.",
        RABBITKINGSPEAR = "Death by rabbit antler. Cute.",
        RABBITHAT = "One helpless prey for me to torment as I please!",
        WORM_BOSS = "No need to test my luck against some bizarre no-eyed beast.",

        STONE_TABLE = -- Shared between the round and square tables.
        {
            GENERIC = "Not bad, not bad at all.",
            HAS_ITEM = "Oh man, this is getting good.",
        },

        STONE_CHAIR =
        {
            GENERIC = "This ain't half bad. I guess...",
            OCCUPIED = "Get off, now! This is MY spot, not yours to claim!",
        },
